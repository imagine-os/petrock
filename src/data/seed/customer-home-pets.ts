...
export function seed(ctx: SeedCtx) {
  ...
  add('notifications', { id: 'ntf_chp_4', user_id: 'usr_customer', kind: 'message', title: 'New message from the front desk', body: 'Encino: "Of course, happy to help. What would you like to know?"', link: '/app/inbox/conv_1', read: true, sent_at: at(D(-6), 15, 45) });
}
