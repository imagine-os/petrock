...
export function seed(ctx: SeedCtx) {
  ...
  add('audit_log', { id: 'aud_acp_1', location_id: null, user_id: 'usr_owner', user_name: 'Jordan Blake', action: 'update', table_name: 'rates', row_id: 'rate_rt_penthouse_weekend_sea_summer', diff: { price_per_night: [150, 155] }, created_at: at(D(-7), 10, 12), updated_at: at(D(-7), 10, 12) });
