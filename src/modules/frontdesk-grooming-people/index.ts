...
export const strings: StringTable = {
  ...
  'frontdesk-grooming-people.open': { en: 'Open', es: 'Abrir' },
  'frontdesk-grooming-people.cardActions': { en: 'Card actions', es: 'Acciones de la tarjeta' },
  'frontdesk-grooming-people.moveTo': { en: 'Move to {status}', es: 'Mover a {status}' },
  'frontdesk-grooming-people.collapseColumn': { en: 'Collapse column', es: 'Contraer columna' },
  'frontdesk-grooming-people.expandColumn': { en: 'Expand column', es: 'Expandir columna' },
  'frontdesk-grooming-people.needsPin': { en: 'Needs a manager PIN', es: 'Requiere PIN de gerente' },
  'frontdesk-grooming-people.noneHere': { en: 'Nothing here', es: 'Nada aquí' },
  'frontdesk-grooming-people.boardHint': { en: 'drag a card or use its menu; locked moves ask for a manager PIN', es: 'arrastra una tarjeta o usa su menú; los cambios bloqueados piden un PIN de gerente' },
  'frontdesk-grooming-people.unassigned': { en: 'Unassigned', es: 'Sin asignar' },
  'frontdesk-grooming-people.addonCount': { en: '+{n} add-ons', es: '+{n} extras' },
  'frontdesk-grooming-people.vaccineIssue': { en: 'Vaccine', es: 'Vacuna' },
  'frontdesk-grooming-people.balanceDue': { en: 'Unpaid', es: 'Sin pagar' },
  'frontdesk-grooming-people.needsAttention': { en: 'Check', es: 'Revisar' },
  'frontdesk-grooming-people.time': { en: 'Time', es: 'Hora' },
  'frontdesk-grooming-people.offToday': { en: 'off today', es: 'libre hoy' },
  'frontdesk-grooming-people.moveLeft': { en: 'Move left', es: 'Mover a la izquierda' },
  'frontdesk-grooming-people.moveRight': { en: 'Move right', es: 'Mover a la derecha' },
  'frontdesk-grooming-people.changeColour': { en: 'Change colour', es: 'Cambiar color' },
  'frontdesk-grooming-people.reset': { en: 'Reset', es: 'Restablecer' },
  'frontdesk-grooming-people.picker': { en: 'Picker', es: 'Selector' },
  'frontdesk-grooming-people.hideColumn': { en: 'Hide column', es: 'Ocultar columna' },
  'frontdesk-grooming-people.columnOptions': { en: 'Column options', es: 'Opciones de columna' },
  'frontdesk-grooming-people.overCapacity': { en: 'Over grooming capacity', es: 'Sobre la capacidad de grooming' },
  'frontdesk-grooming-people.now': { en: 'Now', es: 'Ahora' },
  'frontdesk-grooming-people.alertsCount': { en: '{n} alerts', es: '{n} avisos' },
  'frontdesk-grooming-people.hiddenColumns': { en: 'Hidden:', es: 'Ocultas:' },
  'frontdesk-grooming-people.gridLegend': { en: 'Tinted cells = working hours · hatched = off · click a slot to book · drag or use the card menu to move', es: 'Celdas con tinte = horario laboral · rayado = libre · haz clic en un hueco para reservar · arrastra o usa el menú de la tarjeta para mover' },
};
