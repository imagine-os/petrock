...
export const petsDatesSpec = defineSpec({
  code: 'C-30', name: 'Hotel: choose pets & dates',
...
export const roomTypeSpec = defineSpec({
  code: 'C-31', name: 'Hotel: choose room type',
...
export const petDetailsSpec = defineSpec({
  code: 'C-32', name: 'Hotel: pet stay details',
  ...
  notes: ['Resolves open question 42: the form is per pet (one section each), titled once; the unlabeled date is the last flea dose.'],
});

export const groomingSpec = defineSpec({
  code: 'C-33', name: 'Hotel: add grooming during the stay',
...
export const customerDetailsSpec = defineSpec({
  code: 'C-34', name: 'Hotel: customer details',
...
export const confirmationSpec = defineSpec({
  code: 'C-37', name: 'Hotel: confirmation',
...
export const reservationsSpec = defineSpec({
  code: 'C-38', name: 'My reservations',
...
export const reservationDetailSpec = defineSpec({
  code: 'C-39', name: 'Reservation detail',
...
export const invoiceSpec = defineSpec({
  code: 'C-40', name: 'Reservation invoice',
...
export const changeRequestSpec = defineSpec({
  code: 'C-41', name: 'Request a change',
