...
export function ChangeRequestPage() {
  ...
  return (
    <HotelBookingFrame title="Request a change" subtitle={booking.code} backTo={`/app/bookings/${booking.id}`} footer={<Button size="lg" block loading={busy} disabled={!valid} onClick={submit} icon="message">Send request</Button>} footerNote="The front desk reviews every change; you get a notification when it is handled.">
