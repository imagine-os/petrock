...
export function TokensPage() {
  ...
  return (
    <div className="page stack">
      ...
      <Section title="Typography" description="Open Sans 400 / 600 / 700 (--font-sans) and Be Vietnam Pro 400 / 500 / 600 (--font-display, D-188). 12 / 14 / 16 / 18 / 20 / 22 / 24 / 32; Figma 8 / 10 px roles render at the 12 px floor.">
