...
export const strings = {
  ...
  [P + 'profile.pets']: T('My pets', 'Mis mascotas'), [P + 'profile.payments']: T('Payment methods', 'Métodos de pago'), [P + 'profile.notifications']: T('Notifications', 'Notificaciones'),
  [P + 'profile.chat']: T('Front Desk chat', 'Chat con recepción'), [P + 'profile.settings']: T('App settings', 'Ajustes de la app'), [P + 'profile.settings.desc']: T('Language, dark mode, password', 'Idioma, modo oscuro, contraseña'),
  [P + 'profile.help']: T('Help & support', 'Ayuda y soporte'), [P + 'profile.rate']: T('Rate the app', 'Valorar la app'), [P + 'profile.about']: T('About & legal', 'Acerca de y legal'), [P + 'profile.logout']: T('Log out', 'Cerrar sesión'),
  ...
  [P + 'settings.title']: T('App settings', 'Ajustes de la app'), [P + 'settings.appearance']: T('Appearance', 'Apariencia'), [P + 'settings.language']: T('Language', 'Idioma'), [P + 'settings.dark']: T('Dark mode', 'Modo oscuro'),
  ...
  [P + 'notif.title']: T('Notifications', 'Notificaciones'), [P + 'notif.inbox']: T('Inbox', 'Bandeja'), [P + 'notif.all']: T('All', 'Todas'), [P + 'notif.unread']: T('Unread', 'Sin leer'), [P + 'notif.markAll']: T('Mark all read', 'Marcar todo leído'),
