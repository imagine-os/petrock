...
export const todaySpec = defineSpec({
  ...
  data: ['bookings', 'booking_pets', 'daycare_bookings', 'appointments', 'customers', 'pets', 'rooms', 'room_types', 'vaccine_records', 'vaccine_types', 'booking_events', 'approvals', 'audit_log'], roles: DESK,
...
export const boardSpec = defineSpec({
  ...
  data: ['appointments', 'customers', 'pets', 'employees', 'packages', 'addons', 'bookings', 'vaccine_records', 'vaccine_types', 'approvals', 'audit_log'], roles: STAFF_ROLES,
