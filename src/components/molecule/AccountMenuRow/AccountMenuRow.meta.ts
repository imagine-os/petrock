...
export default defineMeta({
  ...
  props: [{ name: 'icon', type: 'IconName', required: true, description: 'Icon; outline names map to the Figma filled exports (FILLED_ICON)' }, { name: 'chevron', type: 'boolean', default: 'false', description: 'Show the grey row chevron (Figma rows have none)' }, { name: 'label', type: 'ReactNode', required: true, description: 'Row label' }, { name: 'description', type: 'ReactNode', description: 'Second line' }, { name: 'value', type: 'ReactNode', description: 'Value before the chevron' }, { name: 'trailing', type: 'ReactNode', description: 'Replaces the chevron' }, { name: 'to', type: 'string', description: 'Route (renders a Link)' }, { name: 'onClick', type: '() => void', description: 'Action (renders a button)' }, { name: 'tone', type: "'default'|'primary'|'accent'|'danger'", default: 'default', description: 'Icon tint; danger colours the label too' }],
