...
export default defineMeta({
  ...
  usages: [{ title: 'Customer inbox', render: () => h(MemoryRouter, null, h(Card, { padding: 'none', style: { maxWidth: 390 } }, h(ChatConversationRow, { title: 'Front Desk · Encino', preview: 'He made a new friend, a Labradoodle called Nala.', time: '9:24 AM', unread: 2, to: '/x' }), h(ChatConversationRow, { title: 'Front Desk · Westwood', preview: 'Thanks, we will see you at 7:00 AM.', previewPrefix: 'You: ', time: 'Sep 9', to: '/x' }), h(ChatConversationRow, { title: 'Avery Thompson', personName: 'Avery Thompson', preview: 'Could you send a photo?', time: '2 min ago', unread: 1, onClick: () => {} }))) }],
