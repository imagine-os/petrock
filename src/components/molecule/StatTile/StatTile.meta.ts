...
export default defineMeta({
  ...
  props: [{ name: 'label', type: 'string', required: true, description: 'KPI card per front desk-4.jpg: 40 px purple icon square + 16 px label, 28 px bold value, hint / delta under a hairline; desk shadow.' }, { name: 'value', type: 'ReactNode', required: true, description: 'Big number' }, { name: 'delta', type: '{ value, positive? }', description: 'Change vs previous' }, { name: 'icon', type: 'IconName', description: 'Icon' }, { name: 'tone', type: "'default'|'primary'", default: 'default', description: 'Filled primary variant' }],
