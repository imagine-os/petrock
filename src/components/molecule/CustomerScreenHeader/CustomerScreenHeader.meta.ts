...
export default defineMeta({
  ...
  props: [{ name: 'title', type: 'ReactNode', required: true, description: 'Screen title' }, { name: 'subtitle', type: 'ReactNode', description: 'Small line under the title' }, { name: 'rule', type: 'boolean', default: 'true', description: '1 px #B6B6B6 rule under the header (Figma 1807:27182)' }, { name: 'backTo', type: 'string | number | null', description: 'Back target; omitted / -1 = history back; null = no chevron' }, { name: 'actions', type: 'ReactNode', description: 'Right slot' }, { name: 'sticky', type: 'boolean', default: 'true', description: 'Sticks to the top while scrolling' }, { name: 'align', type: "'center'|'start'", default: 'center', description: 'Title alignment' }],
