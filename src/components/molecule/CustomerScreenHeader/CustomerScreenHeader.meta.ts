...
export default defineMeta({
  ...
  usages: [
    { title: 'Centered with action', render: () => h(MemoryRouter, null, h('div', { style: { maxWidth: 390, border: '1px solid var(--color-border)', borderRadius: 12 } }, h(CustomerScreenHeader, { title: 'Front Desk · Encino', subtitle: 'Usually replies in minutes', actions: h(IconButton, { icon: 'bell', label: 'Notifications', badge: 2 }) }))) },
    { title: 'Left aligned, no back', render: () => h(MemoryRouter, null, h('div', { style: { maxWidth: 390, border: '1px solid var(--color-border)', borderRadius: 12 } }, h(CustomerScreenHeader, { title: 'Settings', align: 'start', backTo: null }))) },
  ],
