...
export default defineMeta({
  tier: 'atom', name: 'Badge', description: 'Small status label. StatusBadge renders the one booking lifecycle with the R-I01 colours; toneFor() maps other enums.',
  ...
  usages: [
    ...
    { title: 'Booking lifecycle', render: () => h('div', { className: 'row wrap' }, ...BOOKING_STATUSES.map((s) => h(StatusBadge, { key: s, status: s }))) },
  ],
