...
export default defineMeta({
  ...
  props: [{ name: 'status', type: 'BookingStatus', required: true, description: 'Lifecycle status' }, { name: 'customer', type: 'boolean', default: 'false', description: 'Use BOOKING_STATUS_CUSTOMER_LABEL' }, { name: 'size', type: "'sm'|'md'", default: 'md', description: 'Height 20 / 24' }],
