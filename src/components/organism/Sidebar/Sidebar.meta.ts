...
export default defineMeta({
  tier: 'organism', name: 'Sidebar', description: 'Categorised side menu (D-014) in the Figma sidebar skin (front desk.jpg): 243 px white, logo row with the expand-all / collapse-all and rail icon buttons, letter-spaced grey group labels (chevron on hover), 44 px items on a 50 px rhythm with 24 px icons and 16 px labels, purple active text, #D8D9D9 group dividers, Log Out footer. Categories come from routes with `nav` filtered by role.',
