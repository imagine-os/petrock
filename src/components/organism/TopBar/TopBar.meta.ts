...
export default defineMeta({
  ...
  props: [{ name: 'title', type: 'ReactNode', description: 'Surface title' }, { name: 'onMenu', type: '() => void', description: 'Opens the sidebar drawer on narrow screens' }, { name: 'children', type: 'ReactNode', description: 'Middle slot (search, quick actions)' }, { name: 'showLocation', type: 'boolean', default: 'true', description: 'Location switcher' }],
