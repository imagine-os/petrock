...
| `rates / seasons` | read | avg nightly rate for the dates (R-X59) |
...
- R-E09 / R-X57 - pets >= 30 lb need a bottom penthouse room; blocked when none is free
- R-X56 / R-E11 / R-E12 - capacity minus overlapping stays; rooms needed = 1 when sharing else pets count
- R-D01, R-D05, R-D06 - room types and rate kinds behind the average price
- R-X59 - average nightly rate per pet for the chosen dates
