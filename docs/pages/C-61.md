...
- R-X16 - check-out at least 1 h after check-in and inside hours; closed days disabled
- R-X02 / R-X17 - grooming fits only when hours*60 >= shortest package + buffer
