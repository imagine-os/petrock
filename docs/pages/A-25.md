...
code: A-25
route: /admin/pricing/addons
roles: owner, super_admin
status: built
module: admin-control-panel
figma: front desk-6.jpg
---

# A-25 · Grooming add-ons

## Purpose

Add-ons with price, starting-at flag, minutes added for S-M and L+ dogs and an employee-type restriction.

## Screenshots

| 390 | 1280 |
| --- | --- |
| ![390](../screenshots/A-25/390.jpg) | ![1280](../screenshots/A-25/1280.jpg) |
...
- `R-G10` - Calendar time per package and size
- `R-G11` - Add-on prices
- `R-G12` - Some add-ons restricted to an employee type
- `R-L06` - Add-ons can be restricted to an employee type
- `R-X44` - Pricing pages never hardcode a price
- `R-X41` - Every Control Panel change is written to the audit log

## Logic

- quoteGrooming() adds addon price and added minutes by size band.
- employee_type restricts who can perform it (R-L06).
