...
# F-61 · Website inquiries

> Integration note (2026-09-18): the customer chat inbox at `/desk/messages` is F-57 (frontdesk-grooming-people: assignment, filters, close). F-61 now holds only the website inquiries table at `/desk/inquiries`; the sections below describing the chat pane refer to F-57.
...
- Composer needs messages.write; inquiries status flow new -> seen -> replied -> closed (R-X72).
