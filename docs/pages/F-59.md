...
- `R-X67` - see `src/rules/` (registry) and the Rules tab of the inspector on this page
...
- Create invoice numbers from settings.invoice.next_number (R-X67)
...
- 0019 - QA fixes: Invoice lines for a booking come from `quoteLinesOf()` (app bookings no longer break).
