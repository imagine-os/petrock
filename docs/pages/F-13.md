...
figma: all reservation grooming-1.jpg, all reservation grooming-2.jpg, all reservation grooming-3.jpg, all reservation grooming.jpg
---
...
1. PageHeader - ViewSwitch, week navigator (`ReservationDayNav` with range), 1 week / 2 weeks, New booking
2. Filter bar - room type, status, Unassigned row, Daycare rows, Cancelled / no show
3. Legend - status swatches and flag meaning
4. `RoomTimeline` - groups Unassigned, Penthouses, Suites, Daycare (Full day / Half day / Play hour)
5. Block popover - code, status, customer, dates, room, pets, balance, vaccine chips, notes; Open / Assign room / Set status
6. Move modal - from / to confirmation (R-X07); RoomPickModal; PinApprovalModal
...
PageHeader, SegmentedControl, ReservationDayNav, Select, Toggle, Button, Badge, StatusBadge, Modal, RoomTimeline, PetVaccineStatus, BookingStatusMenu, RoomAssignmentPicker, PinApprovalModal.
