...
- R-X32 - customers request changes; unconfirmed stays cancel directly, confirmed stays need the desk
- R-I06 - the desk approves a confirmed cancellation with a manager PIN
- R-A05 / R-X31 - pending vaccines hint with link to upload proofs
- R-X30 - balance due at check-in
