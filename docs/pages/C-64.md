...
One daycare day: confirmation right after checkout, status, pets and their questionnaire answers, payment and invoice totals. Actions: Book again (prefills a new draft), Cancel booking while not confirmed (R-X04), Message the front desk afterwards, and "Book grooming" when the day is long enough for a groom (R-X07).
...
- R-X04 - cancel before confirmation only
- R-X07 / R-X02 - grooming offered when hours*60 >= shortest package + 60
