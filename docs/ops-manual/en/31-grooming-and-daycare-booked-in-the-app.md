---
title: Grooming & Spa and Daycare booked in the app
code: M-31
roles: front desk, groomer, manager
part: III
version: 0.2.0
updated: 2026-09-18
summary: Audience: front desk, groomers, managers. Pages: C-50..C-56 (Grooming & Spa), C-60..C-65 (Daycare). Screenshots: docs/screenshots/C-5x, docs/screenshots/C-6x.
rules: 
---

# Grooming & Spa and Daycare booked in the app

> NOTE: Folded from the module draft `customer-grooming-daycare` at integration (2026-09-18).
