# Grooming & Spa, customers, pets and messages at the front desk (draft chapter)

For: front desk, groomers, managers. Pages: F-30 Day view, F-31 Board, F-32 Agenda list, F-33 New groom booking, F-34 Appointment, F-50 Customers, F-51 Add customer, F-52 Customer, F-53 Pets, F-54 Add pet, F-55 Pet & vaccines, F-56 Verification queue, F-57 Inbox, F-58 Notifications, F-59 Invoice.
...
- **Notifications** (F-58): the bell in the top bar. New app bookings, uploaded proofs, messages and approvals; open one to jump to the page.
