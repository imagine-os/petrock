...
decision: D-185 (proposed) Open Sans replaces Inter as the app family, Be Vietnam Pro for display roles; D-186..D-188 (proposed) home header without location chip / bell, wizard stepper count, hotel flow without stepper - defaults stated in the audit, Justin to confirm.
