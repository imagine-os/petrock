...
- **docs/project-brief.md**: source line now cites prompt 0002 and links `docs/decisions.md`; scope table gains vaccines, "one service" for grooming & spa, owner-only Control Panel, Settings > Rules, and an Extras row; new sections "Theming" (under the design system), "Business rules registry" and "Services"; design-source bullet records the confirmed scope; Santa Maria access status updated.
